...
all_files = os.listdir(os.path.join(args.set, args.set, 'image'))
sub_index = 0  # the index of ground truth instance
for file in tqdm(all_files):
    json_name = os.path.join(args.set, args.set, 'annos', os.path.splitext(file)[0] + '.json')
    image_name = os.path.join(args.set, args.set, 'image', file)
...
json_name = os.path.join('deepfashion2_coco_' + args.set + '.json')
